...
import '../styles/pages-styles/Representante-home.scss';
...
export default function RepresentantePrincipal() {
      ...
      <div className='content-global'>
        ...
        <div className='conteudo-cotainner'>
         ...
         <div className='titulo-page'>
            ...
            <div style={{margin:"auto"}} className='logo-representante'></div>
