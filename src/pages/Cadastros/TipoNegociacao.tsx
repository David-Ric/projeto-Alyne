  ...
  return (
    <>
      ...
      {alertErroRegister && (
            ...
            {inInsert?(<></>):(<>
                    <button style={{marginTop:30}} className='btn btn-primary btn-pesquisas btn-pesquisar'onClick={()=>{setPagina(1);GetTipoNegociacaoFilter()}}>Pesquisar<FaSearchPlus style={{marginLeft: 6}} fontSize={17}/></button>
